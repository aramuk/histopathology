...
class Veggie16(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        architecture.classifier[6] = nn.Linear(4096, 2)
        self.classifier = architecture.classifier
...
class Trainer:
    ...
    def __init__(self, model, device, model_dir='./models/'):
        ...
        self.final_file = os.path.join(model_dir, model.__class__.__name__ + '_ckpt.pth')
    ...
    def load_checkpoint(self):
        ...
        if os.path.exists(os.join(self.model_dir,self.checkpoint_file)):
            self.model.load_state_dict(torch.load(self.checkpoint_file))
            print('Successfully Loaded Checkpoint from: '+os.join(self.model_dir,self.checkpoint_file))
        else:
            print('No Checkpoint Found at: '+os.join(self.model_dir,self.checkpoint_file))
